# -*- coding: utf-8 -*-
"""
Created on Tue Apr  4 10:11:00 2023
...
import xraydb
## PEEK material added to database
xraydb.add_material('PEEK', 'C19H14O3', 1.32, categories=['polymer'])
...
class XASCalcUI(QMainWindow):
    ...
    def __init__(self):
        ...
        self.screenW = rect.width()
        self.screenH = rect.height()

        self.SampleDilutionBlockWidth = round(300/1290*self.screenW)

        self.XrayInputBlockWidth = round(230/1290*self.screenW)

        self.XrayInputBlockHight = round(570/1162*self.screenH)

        self.XraytextboxW = round(90/1290*self.screenW)
        self.XraytextboxH = round(27/1162*self.screenH)

        self.XraytextboxW2 = round(45/1290*self.screenW)

        self.XrayInputBlockHight2 = round((self.XrayInputBlockHight+30/1162)*self.screenH)

        self.ResultsBlockWidth = round(220/1290*self.screenW)

        self.PropertiesBlockWidth = round((230+50+20+10)/1290*self.screenW)
        ...
        # Set Icon
        #self.setWindowIcon(QIcon(fct.resource_path('CoACCESSScale_v4')))
        self.setWindowIcon(QIcon(os.path.join(os.getcwd(),'src','images','CoACCESSScale_v4.ico')))
        
        # Set main window's properties
        self.setWindowTitle(self.title)
        #self.setGeometry(self.left, self.top, self.width, self.height)
        XASCalcUI.setFixedHeight(self, self.XrayInputBlockHight+50)
    ...
    def _createPropertiesBlock(self)    :
        ...
        Properties_frame.setFixedWidth(self.PropertiesBlockWidth)
        ...
        'loading windows and hiding it until user selects to view it'
        if self.b3.isChecked()== False:
            ...
            '''Text Labels'''
            # Create Header Label
            self.label_P00 = QLabel('X-ray Transmission Through Common Materials')
            ...
            self.label_P08 = QLabel('X-ray Absorption Through Ion Chamber Gases')
            self.label_P08.setAlignment(Qt.AlignLeft)
            self.label_P08.setStyleSheet("font-weight: bold; text-decoration: underline")
            PropertiesLayout.addWidget(self.label_P08, 7, 0, 1, 4)
            ...
            PropertiesLayout.addWidget(self.label_P09, 10, 0,2,1)
            self.generalLayout.addLayout(PropertiesLayout)
            ...
            PropertiesLayout.addWidget(self.label_P10, 12, 1)
            self.generalLayout.addLayout(PropertiesLayout)
            ...
            PropertiesLayout.addWidget(self.label_P11, 12, 3,2,1)
            self.generalLayout.addLayout(PropertiesLayout)
            ...
            self.textbox_P02.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textbox_P03.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textbox_P04.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textbox_P05.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.combo2.setFixedSize(self.XraytextboxW, self.XraytextboxH)
            ...
            self.combo_U2.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.combo3.setFixedSize(self.XraytextboxW, self.XraytextboxH)
            ...
            self.combo_U3.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.combo4.setFixedSize(self.XraytextboxW, self.XraytextboxH)
            ...
            self.combo_U4.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.combo5.setFixedSize(self.XraytextboxW, self.XraytextboxH)
            ...
            self.combo_U5.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textboxP04.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textboxP05.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textboxP06.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textboxP07.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.combo6.setFixedSize(self.XraytextboxW, self.XraytextboxH)
            ...
            self.combo7.setFixedSize(self.XraytextboxW, self.XraytextboxH)
            PropertiesLayout.addWidget(self.combo7, 8, 3,1,2,Qt.AlignRight)
            line_edit.setAlignment(Qt.AlignCenter)
            line_edit.setReadOnly(True)
            self.generalLayout.addLayout(PropertiesLayout)
            ...
            self.combo_C1.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            self.combo_C1.setCurrentIndex(1)
            PropertiesLayout.addWidget(self.combo_C1, 12, 2,Qt.AlignCenter)
            self.generalLayout.addLayout(PropertiesLayout)
            self.combo_C1.currentTextChanged.connect(self.CalBeamabs)
        
            """Buttons"""
            # Create Button to percent beam
            ...
            self.button_P01 = QPushButton('Reset')
            PropertiesLayout.addWidget(self.button_P01, 15, 0,1,5,)
            self.generalLayout.addLayout(PropertiesLayout)
            self.button_P01.clicked.connect(self.clearxrayprop)
            ...
            self.textboxP08.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textboxP09.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textboxP10.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            ...
            self.textboxP11.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            self.textboxP11.setAlignment(Qt.AlignCenter)
            self.textboxP11.setReadOnly(True)
            PropertiesLayout.addWidget(self.textboxP11, 12, 4,Qt.AlignRight)
            self.generalLayout.addLayout(PropertiesLayout)
            
            self.textboxP12 = QLineEdit()
            self.textboxP12.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
            self.textboxP12.setAlignment(Qt.AlignCenter)
            PropertiesLayout.addWidget(self.textboxP12, 12, 0,Qt.AlignRight)
            self.generalLayout.addLayout(PropertiesLayout)
    ...
    def _createSampleDilutionBlock(self)    :
        ...
        Diluent_frame.setFixedWidth(self.SampleDilutionBlockWidth)
        Diluent_frame.setMinimumHeight(self.XrayInputBlockHight)
        """Define Layout"""
        ...
        self.textbox_dil01.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        ...
        self.textbox_dil02.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        ...
        self.textbox_dil03.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
        DilutionLayout.addWidget(self.textbox_dil03, 4, 1,Qt.AlignCenter)
        self.generalLayout.addLayout(DilutionLayout)
        ...
        self.textbox_dil04.setFixedSize(self.XraytextboxW2, self.XraytextboxH)
        DilutionLayout.addWidget(self.textbox_dil04, 4, 2,Qt.AlignCenter)
        self.generalLayout.addLayout(DilutionLayout)
        
        # Creat "Dummy" label fo Co-ACCESS label
        self.label_dil07 = QLabel(self)
        self.label_dil07.setAlignment(Qt.AlignCenter)
        DilutionLayout.addWidget(self.label_dil07, 9, 0,4,3)
        self.label_dil07.setFixedSize(self.XraytextboxW2,self.XraytextboxH*6) 
        self.generalLayout.addLayout(DilutionLayout)
        ...
        self.textbox_dil05.setPlaceholderText('Diagnostics')
        ...
        #pixmap = QPixmap(images.co_access_logo_text.png)
        pixmap = QPixmap(os.path.join(os.getcwd(),'src','images','co_access_logo_text.png'))
        self.label_dil05.setPixmap(pixmap)
        self.label_dil05.setAlignment(Qt.AlignCenter)
        DilutionLayout.addWidget(self.label_dil05, 8, 0,30,3)
        self.generalLayout.addLayout(DilutionLayout)
        
        # Creat "Dummy" label fo Co-ACCESS label
        self.label_dil06 = QLabel(self)
        self.label_dil06.setAlignment(Qt.AlignCenter)
        DilutionLayout.addWidget(self.label_dil06, 30, 0,4,3)
        self.label_dil06.setFixedSize(self.XraytextboxW2, self.XraytextboxH*6) 
        self.generalLayout.addLayout(DilutionLayout)
        ...
        self.button_dil00.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        ...
        self.button_dil01.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        ...
        self.button_dil02.setFixedSize(round(self.XraytextboxW*2.1), self.XraytextboxH)
    ...
    def _createXrayInputBlock(self):
        ...
        XrayInputFrame.setFixedWidth(self.XrayInputBlockWidth)

        XrayInputFrame.setMinimumHeight(self.XrayInputBlockHight)
        ...
        InputLayout.addWidget(self.label0, 0, 0, 2, 2)
        ...
        InputLayout.addWidget(self.label1, 3, 0,3,1)
        ...
        InputLayout.addWidget(self.label2, 8, 0,2,1)
        self.generalLayout.addLayout(InputLayout)
        ...
        InputLayout.addWidget(self.label3, 12, 0,2,1)
        self.generalLayout.addLayout(InputLayout)
        ...
        InputLayout.addWidget(self.label12, 16, 0,3,1)
        self.generalLayout.addLayout(InputLayout)
        self.label12.hide()
        ...
        InputLayout.addWidget(self.label4, 23, 0,3,1)
        ...
        InputLayout.addWidget(self.label6, 28, 0,2,1)
        self.generalLayout.addLayout(InputLayout)
        
        # Create Lable for Co-ACCESS default cell Area
        self.label7 = QLabel('Co-ACCESS XAS Cells:')
        self.label7.setAlignment(Qt.AlignCenter)
        InputLayout.addWidget(self.label7, 32, 0,2,1)
        self.generalLayout.addLayout(InputLayout)
        # Create Lable for Co-ACCESS default cell Area
        self.label8 = QLabel('')
        self.label8.setAlignment(Qt.AlignCenter)
        InputLayout.addWidget(self.label8, 36, 0,2,1)
        self.generalLayout.addLayout(InputLayout)
        ...
        InputLayout.addWidget(self.label11, 40, 0,2,1)
        self.generalLayout.addLayout(InputLayout)
        
        
        # Create Lable for Desired Area
        self.label5 = QLabel('Sample Area ⊥ to Beam [cm<sup>2</sup>]:')
        self.label5.setAlignment(Qt.AlignCenter)
        InputLayout.addWidget(self.label5, 43, 0,3,1)
        ...
        InputLayout.addWidget(self.label9, 48, 0,2,1)
        ...
        InputLayout.addWidget(self.label10, 52, 0,2,1)
        self.label10.setWordWrap(True)
        self.generalLayout.addLayout(InputLayout)
        
        # Create DUMMY Lable for plot spacing
        self.label15 = QLabel('')
        self.label15.setAlignment(Qt.AlignCenter)
        InputLayout.addWidget(self.label15, 63, 0, 1, 2)
        #self.label10.setWordWrap(True)
        self.generalLayout.addLayout(InputLayout)
        self.label15.setFixedSize(round(self.XraytextboxW*2.21),round(self.XraytextboxH/1.5))
        ...
        self.textbox1.setPlaceholderText('Defined Left')
        self.textbox1.setStyleSheet("background-color:rgb(224,224,224)")
        self.textbox1.setReadOnly(True)
        self.textbox1.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.textbox1, 4, 1,1,1)
        self.generalLayout.addLayout(InputLayout)

        # Create Editable Textbox for Element to be Scanned
        self.textbox2 = QLineEdit()
        self.textbox2.setPlaceholderText('Element Symbol')
        self.textbox2.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.textbox2, 8, 1,1,1)
        self.generalLayout.addLayout(InputLayout)
        ...
        self.combo.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.combo, 12, 1,1,1)
        self.generalLayout.addLayout(InputLayout)
        ...
        self.textbox14.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.textbox14, 16, 1,1,1)
        self.generalLayout.addLayout(InputLayout)
        self.textbox14.hide()
        ...
        self.b2 = QCheckBox()
        InputLayout.addWidget(self.b2, 18, 1,4,1)
        #self.b1.setAlignment(Qt.AlignCenter)
        self.b2.setText("Sample at 45°")
        self.b2.toggled.connect(self.b1_function)
        self.b2.setStyleSheet('QCheckBox::indicator { width: 12px; height: 12px;};')
 
        
        # Create Editable Textbox for Desired Absorption Length
        self.textbox3 = QLineEdit()
        self.textbox3.setPlaceholderText('Target Absorption Length')
        self.textbox3.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.textbox3, 23, 1,1,1)
        self.generalLayout.addLayout(InputLayout)
        self.textbox3.setText('2.6')
        
        
        # Radio button for Capillaries
        self.radioButton1 = QRadioButton(self)
        InputLayout.addWidget(self.radioButton1, 28, 1,3,1)
        self.radioButton2 = QRadioButton()
        InputLayout.addWidget(self.radioButton2, 32, 1,3,1)
        self.radioButton3 = QRadioButton()
        InputLayout.addWidget(self.radioButton3, 36, 1,3,1)
        self.radioButton1.setText("3 mm Capillary")
        self.radioButton2.setText("1 mm Capillary")
        self.radioButton3.setText("7 mm Pellet/Other")
        ...
        self.radioButton1.setStyleSheet('QRadioButton::indicator { width: 11px; height: 11px;};')
        self.radioButton2.setStyleSheet('QRadioButton::indicator { width: 11px; height: 11px;};')
        self.radioButton3.setStyleSheet('QRadioButton::indicator { width: 11px; height: 11px;};')
        
        # Create Editable Textbox bed length
        self.textbox13 = QLineEdit()
        self.textbox13.setPlaceholderText('1')
        self.textbox13.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.textbox13, 41, 1,1,1)
        self.generalLayout.addLayout(InputLayout)
        ...
        self.textbox4.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.textbox4, 44, 1,1,1)
        self.generalLayout.addLayout(InputLayout)
        ...
        self.textbox11.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.textbox11, 48, 1,1,1)
        self.generalLayout.addLayout(InputLayout)
        ...
        self.textbox12.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        InputLayout.addWidget(self.textbox12, 52, 1,1,1)
        self.generalLayout.addLayout(InputLayout)
        self.textbox12.setText('1000')
        
        #checkbox to show plot
        self.b1 = QCheckBox()
        InputLayout.addWidget(self.b1, 56, 1,4,1)
        self.b1.setText("Show Plot")
        self.b1.setStyleSheet('QCheckBox::indicator { width: 12px; height: 12px;};')
        
        #checkbox to show Xray transmission block
        self.b3 = QCheckBox()
        InputLayout.addWidget(self.b3, 56, 0,4,1)
        self.b3.setText("X-ray transmission  \n through media")
        self.b3.toggled.connect(self.b3_function)
        
        self.b3.setStyleSheet('QCheckBox::indicator { width: 12px; height: 12px;};')
        ...
        InputLayout.addWidget(self.textbox_Xray_05, 63, 0,1,2,Qt.AlignCenter)
        self.generalLayout.addLayout(InputLayout)
        self.textbox_Xray_05.setFixedSize(round(self.XraytextboxW*2.2),round(self.XraytextboxH/1.5))

        '''Buttons'''
        #Create Reset Button to Clear X-ray Input Field
        self.button_Input01 = QPushButton('Reset')
        InputLayout.addWidget(self.button_Input01, 61, 0,2,1)
        self.generalLayout.addLayout(InputLayout)
        self.button_Input01.clicked.connect(self.clearDisplay)
        self.button_Input01.setFixedSize(self.XraytextboxW, self.XraytextboxH)
        #Create Button to Calcualte sample mass and step
        self.button_Input02 = QPushButton('Calculate Sample Mass')
        InputLayout.addWidget(self.button_Input02 ,61, 1,2,1)
        self.generalLayout.addLayout(InputLayout)
        self.button_Input02.clicked.connect(self.calculateResult)
        self.button_Input02.setFixedSize(self.XraytextboxW, self.XraytextboxH)
    ...
    def b1_function_previoussave(self):
        if self.b2.isChecked()== False:
            ...
            self.label5.setText('Sample Area ⊥ to Beam [cm<sup>2</sup>]:')
            ...
            self.label5.setText('Projected Sample Area 45° to Beam [cm<sup>2</sup>]:')
            self.label5.setWordWrap(True)
    ...
    def b1_function(self):
        ...
        'Pending Error'
        'if blank then return error in diagnostic'        
        if self.b2.isChecked()== False:
    ...
    def b3_function(self):
        ...
        if self.b3.isChecked()== False:
            ...
            child.widget().hide()
            XASCalcUI.setFixedWidth(self, self.SampleDilutionBlockWidth+self.XrayInputBlockWidth+self.ResultsBlockWidth+40)
            
        else:
            XASCalcUI.setFixedWidth(self, self.SampleDilutionBlockWidth+self.XrayInputBlockWidth+self.ResultsBlockWidth+self.PropertiesBlockWidth+40)
            self._createPropertiesBlock()
    ...
    def on_combobox_previoussave(self):
        if self.combo.currentIndex() == 4:
            ...
            XASCalcUI.setFixedHeight(self, self.XrayInputBlockHight2+40)
            XrayInputFrame.setFixedHeight(self.XrayInputBlockHight2)
        else:
            self.textbox14.hide()
            self.label12.hide()
            self.textbox2.setStyleSheet("background-color:rgb(255,255,255)")
            self.textbox2.setReadOnly(False)
            XASCalcUI.setFixedHeight(self, self.XrayInputBlockHight+40)
    ...
    def _createResultsBlock(self):
        ...
        ResultsFrame.setFixedWidth(self.ResultsBlockWidth)
        ResultsFrame.setMinimumHeight(self.XrayInputBlockHight)
        ...
        OutputLayout.addWidget(self.label6, 1, 0,1,2)
        self.generalLayout.addLayout(OutputLayout)
        ...
        OutputLayout.addWidget(self.label7, 2, 0,1,2)
        ...
        OutputLayout.addWidget(self.label8, 3, 0,1,2)
        self.generalLayout.addLayout(OutputLayout)
        ...
        OutputLayout.addWidget(self.label9, 4, 0,1,2)
        self.generalLayout.addLayout(OutputLayout)
        ...
        OutputLayout.addWidget(self.label10, 5, 0,1,2)
        self.generalLayout.addLayout(OutputLayout)
       
        
        self.label11 = QLabel(self)
        pixmap = QPixmap(os.path.join(os.getcwd(),'src','images','SSRL_logo_2021.png'))
    ...
    def opencatfile(self):
       ...
       if filePath =='':
           self.textbox_dil05.setText('No File Imported')
       else:
           i = 1
    ...
    def calculateResult(self):
        ...
        if self.b1.isChecked()== False:
            ...
            axis[0].set_ylim([0, max(y)*1.5])
            axis[0].set_ylabel(r"Sample Absorption ($µ_{average}$ • Mass/Area)")
            
            axis[1].set_xlim([0, fct.kspacecalc(delta2)])
            #axis[1].yaxis.set_visible(False)
            axis[1].set_yticklabels([])
            axis[1].set_ylabel(r"Metal Edge Position(s)")
    ...
    def openSampleBuilder(self):
        self.dialog = SampleBuilder(parent = self)
        self.dialog.show()
    ...
    def CalBeamabs(self):
        if self.textbox9.text()=='':
            ...
            ionchamberdensityy = fct.ionchamberdensity(self.slider2.value(),self.combo6.currentText(),self.combo7.currentText(),-self.slider.value()/100)
            Enot = self.textbox9.text()

            if self.combo_C1.currentIndex() == 5:
                self.textboxP12.show()
                ionchambergas1 =  -self.slider.value()/100*float(self.textboxP12.text())*xraydb.material_mu(self.combo6.currentText(),float(Enot),density=ionchamberdensityy)
                ionchambergas2 =  (100+self.slider.value())/100*float(self.textboxP12.text())*xraydb.material_mu(self.combo7.currentText(),float(Enot),density=ionchamberdensityy)
                transionchamber = np.exp(-(ionchambergas1+ionchambergas2))*100
          
            else:
                self.textboxP12.hide()
                ionchambergas1 =  -self.slider.value()/100*float(self.combo_C1.currentText())*xraydb.material_mu(self.combo6.currentText(),float(Enot),density=ionchamberdensityy)
                ionchambergas2 =  (100+self.slider.value())/100*float(self.combo_C1.currentText())*xraydb.material_mu(self.combo7.currentText(),float(Enot),density=ionchamberdensityy)
                transionchamber = np.exp(-(ionchambergas1+ionchambergas2))*100
...
class MyTableWidget(QWidget):
    def __init__(self, parent):
        ...
        self.tabs.addTab(self.tab2,"Supported Metal Complexes")
        ...
        self.textbox_tab106.setAlignment(Qt.AlignCenter)
        ...
        # Create Label for Notes
        self.label_tab2_06 = QLabel('Note: for metal oxides or organometallic complexes')
...
class InfoWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.width = 480#640
        self.height = 640#480
        InfoWindow.setFixedWidth(self, 450)
        # Set main window's properties
        self.setWindowTitle(self.title)
        layout = QGridLayout()
        ...
        self.label_Info21 = QLabel('Author Information: Adam S. Hoffman, Jorge E. Perez-Aguilar')
        self.label_Info21.setAlignment(Qt.AlignLeft)
        layout.addWidget(self.label_Info21, 4, 0,1,4)
        self.label_Info21.setWordWrap(True)
        self.setLayout(layout)
        ...
        layout.addWidget(self.label_Info05, 5, 0, 1, 4)
...
if __name__ == "__main__":
    def run_app():
        ...
        mainWin = XASCalcUI()
        mainWin.setStyleSheet(''' font-size: 11px; ''')
        mainWin.saveState()
